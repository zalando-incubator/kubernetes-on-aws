...
const (
	...
	nonCompliantImage1  = "container-registry-test.zalando.net/teapot/skipper-test:pr-2216-6" // these are several non-compliant images
	nonCompliantImage2  = "container-registry-test.zalando.net/teapot/skipper-test:pr-2216-10"
	nonCompliantImage3  = "container-registry-test.zalando.net/teapot/skipper-test:pr-2216-11"
	nonCompliantImage4  = "container-registry-test.zalando.net/teapot/skipper-test:pr-2238-1"
	nonCompliantImage5  = "container-registry-test.zalando.net/teapot/skipper-test:pr-2238-2"
	nonCompliantImage6  = "container-registry-test.zalando.net/teapot/skipper-test:pr-2239-1"
	nonCompliantImage7  = "container-registry-test.zalando.net/teapot/skipper-test:pr-2241-1"
