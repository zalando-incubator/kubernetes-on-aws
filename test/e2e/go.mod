...
require (
	...
	github.com/zalando-build/sandbox-controller v0.0.0-20260619153033-7f8e0f6ec5b5
	github.com/zalando-build/shadow-traffic-controller v0.0.0-20260622091415-a5a904563bf3
